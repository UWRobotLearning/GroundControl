...
def get_sbx_entry_point(algorithm: str = "sac"):
    if algorithm.lower() == "sac":
        return "sbx_sac_cfg_entry_point"
    elif algorithm.lower() == "ppo":
        return "sbx_ppo_cfg_entry_point"
    else:
...
@hydra_task_config(args_cli.task, get_sbx_entry_point(args_cli.algorithm))
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg, agent_cfg: dict):
    ...
    log_dir = os.path.join("logs", "sbx", args_cli.task, datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
