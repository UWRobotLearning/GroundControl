...
# Pre-defined configs
##
from groundcontrol_assets.unitree import UNITREE_GO2_CFG  # isort: skip
...
class Go2ObservationsCfg:
    ...
    sensorObs: SensorsCfg = SensorsCfg()
...
class Go2TerminationsCfg:
    ...
    body_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=["base_link", ".*hip"]), "threshold": 1.0},
    )
