...
# Pre-defined configs
##
from groundcontrol_assets.robots.unitree import UNITREE_GO2_CFG  # isort: skip

#TODO/NOTE: These rewards/events were borrowed and modified from the well-tuned Spot configs. We should not assume
# that they are the best for Go2. We should tune them for Go2 in the future and enure sim2real transfer is reliable.
...
class Go2TerminationsCfg:
    ...
    body_contact = DoneTerm(
        ...
        #TODO: add other contact links for termination if necessary            ,^
    )
