...
@configclass
class UnitreeA1FlatSACRunnerCfg(SACRunnerConfig):
...
@configclass
class UnitreeA1FlatREDQRunnerCfg(REDQRunnerConfig):
    experiment_name = "unitree_a1_flat"
    log_interval = 1000
    save_interval = 10000
    eval_episodes = 3
...
@configclass
class UnitreeA1FlatDroQRunnerCfg(DroQRunnerConfig):
    experiment_name = "unitree_a1_flat"
    log_interval = 1000
    save_interval = 10000
    eval_episodes = 3
