...
@configclass
class RLPDSACAlgorithmConfig:
    algorithm_name: str = "rlpd_sac"
    actor_lr: float = 3e-4  
    ...
    policy: RLPDSACPolicyConfig = RLPDSACPolicyConfig()
...
@configclass
class RLPDSACRunnerConfig:
    algorithm: RLPDSACAlgorithmConfig = RLPDSACAlgorithmConfig()

    seed: int = 42
    env_name: str = MISSING #"HalfCheetah-v4"  ## Good
    dataset_path: str = MISSING #"buffer.npz"  ## Good
    experiment_name: str = "rlpd_sac"  # Used for wandb and project folder logging
...
@configclass
class RLPDREDQRunnerConfig(RLPDSACRunnerConfig):
    algorithm: RLPDSACAlgorithmConfig = RLPDSACAlgorithmConfig(
...
@configclass
class RLPDDroQRunnerConfig(RLPDSACRunnerConfig):
    algorithm: RLPDSACAlgorithmConfig = RLPDSACAlgorithmConfig(
