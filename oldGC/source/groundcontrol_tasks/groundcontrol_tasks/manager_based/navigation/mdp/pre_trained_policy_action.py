...
class PreTrainedPolicyAction(ActionTerm):
    ...
    def __init__(self, cfg: PreTrainedPolicyActionCfg, env: ManagerBasedRLEnv) -> None:
        ...
        ### === This is the line that translates the SE2 pose command which is an action in UpperLevel ===
        ### === to the a part of the observation (as a velocity command) in the LowLevel Policy ===
    ...
    def action_dim(self) -> int:
        # This is hardcoded to 3 for the SE2 pose command space
        return 3
